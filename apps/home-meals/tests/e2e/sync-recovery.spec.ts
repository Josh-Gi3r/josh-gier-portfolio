...
function state(activePrepIds:string[]=[]){return {version:12 as const,week:[...week],weekStatus:"confirmed" as const,suggestedWeek:null,planMode:"both" as const,allowExtraPrep:true,monthlyPool:[...week],activePrepIds,componentBatches:[],manualComponentStock:{},ingredientStock:{},qualitativeIngredientStock:{},groceryChecked:{},ratings:{},recipeNotes:{},recipeVersions:{},history:[],cookObservations:[],useSoon:{},useSoonAt:{},favourites:{},kitchenReady:true,migrationWarnings:[]}}
