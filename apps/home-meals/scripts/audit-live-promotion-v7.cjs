...
try{
 ...
 const compile=['data/ingredient-catalog-v7.ts','data/phase2-live-candidates-v7.ts','data/phase2-promotion-registry-v7.ts','data/phase2-runtime-v7.ts','data/ingredient-engine-v7.ts','data/food-engine-v7.ts','data/runtime-dinner-v7.ts'];
 ...
 const v7IngredientSource=read('data/ingredient-engine-v7.ts'),v7FoodSource=read('data/food-engine-v7.ts'),v7RuntimeSource=read('data/runtime-dinner-v7.ts');
