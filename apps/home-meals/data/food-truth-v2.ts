...
export const canonicalPrepComponentsV2: readonly CanonicalPrepComponentV2[] = [
  ...
  c({ id:"blond", code:"BLOND", name:"Italian soffritto", tier:"mother", form:"cooked-base", storageMode:"freezer-core", workingUnit:q(60,"g"), madeFrom:[], usedWith:[], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
  ...
  c({ id:"makhani", code:"MAKHANI", name:"Makhani sauce concentrate", tier:"mid", form:"sauce", storageMode:"freezer-rotational", workingUnit:q(120,"g"), madeFrom:["gold"], usedWith:[], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
  ...
  c({ id:"korma", code:"KORMA", name:"Korma nut-onion concentrate", tier:"mid", form:"paste", storageMode:"demand-driven", workingUnit:q(100,"g"), madeFrom:["onion"], usedWith:[], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
  ...
  c({ id:"malaysian-kari", code:"KARI", name:"Malaysian curry paste", tier:"mid", form:"paste", storageMode:"demand-driven", workingUnit:q(150,"g"), madeFrom:[], usedWith:[], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
  c({ id:"asam-pedas", code:"ASAM", name:"Asam pedas paste", tier:"mid", form:"paste", storageMode:"demand-driven", workingUnit:q(100,"g"), madeFrom:[], usedWith:[], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
  ...
  c({ id:"douban", code:"DOUBAN", name:"Doubanjiang aromatic concentrate", tier:"mid", form:"paste", storageMode:"demand-driven", workingUnit:q(30,"g"), madeFrom:[], usedWith:[], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
  ...
  c({ id:"gochujang", code:"GOCHU", name:"Gochujang finishing sauce", tier:"mid", form:"sauce", storageMode:"fridge-first", workingUnit:q(30,"g"), madeFrom:[], usedWith:[], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
  c({ id:"harissa", code:"HARISSA", name:"Harissa concentrate", tier:"mid", form:"paste", storageMode:"freezer-rotational", workingUnit:q(30,"g"), madeFrom:[], usedWith:["red"], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
  c({ id:"chipotle", code:"CHIPOTLE", name:"Chipotle-adobo concentrate", tier:"mid", form:"paste", storageMode:"freezer-rotational", workingUnit:q(30,"g"), madeFrom:[], usedWith:["red"], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
  c({ id:"pesto", code:"PESTO", name:"Pesto freezer base", tier:"mid", form:"paste", storageMode:"freezer-rotational", workingUnit:q(30,"g"), madeFrom:[], usedWith:[], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured", note:"Stored freezer base may hold cheese until serving; do not label the freezer object as complete traditional pesto if formulation differs." }),
  ...
  c({ id:"chilli", code:"CH", name:"Neutral chilli paste", tier:"booster", form:"aromatic", storageMode:"freezer-core", workingUnit:q(15,"g"), madeFrom:[], usedWith:[], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
  c({ id:"lemongrass", code:"LE", name:"Lemongrass-galangal aromatic", tier:"booster", form:"aromatic", storageMode:"freezer-core", workingUnit:q(15,"g"), madeFrom:[], usedWith:[], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
  ...
  c({ id:"miso-ginger", code:"MISO-G", name:"Miso-ginger marinade", tier:"booster", form:"marinade", storageMode:"fridge-first", workingUnit:q(30,"g"), madeFrom:[], usedWith:[], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
  c({ id:"bulgogi", code:"BUL", name:"Bulgogi marinade", tier:"booster", form:"marinade", storageMode:"demand-driven", workingUnit:q(60,"g"), madeFrom:[], usedWith:[], researchConfidence:"B", truthState:"formulation_locked", measurementStatus:"unmeasured" }),
] as const;
...
export const recipePrepRequirementsV2: Readonly<Record<string, readonly RecipePrepRequirementV2[]>> = {
  ...
  "beef-broccoli":[r("wok-brown",125,"ml")],
  "brown-chicken-mushroom":[r("wok-brown",125,"ml")],
  "moo-goo-gai-pan":[r("wok-white",150,"ml")],
  "white-sauce-prawns":[r("wok-white",150,"ml")],
  "wok-tofu-greenbeans":[r("wok-brown",125,"ml"),r("chilli",15,"g")],
  "teriyaki-salmon":[r("teriyaki",60,"ml")],
  "teriyaki-chicken":[r("teriyaki",60,"ml")],
  "miso-salmon":[r("miso-ginger",60,"g")],
  "miso-aubergine-tofu":[r("miso-ginger",60,"g")],
  "bulgogi-beef":[r("bulgogi",60,"g")],
