...
export const motherProcessImages:Record<string,ProcessAsset[]>={
 red:[
  ...
  {stage:"04 · MEASURE + PACK",caption:"Cool, measure the exact finished output, then divide into labelled storage packets plus any remainder.",url:hf("20260911_143802_171bc463-255a-4cd0-b26e-f7edb5351b9c")}
 ],
 gold:[
  ...
  {stage:"04 · MEASURE + PACK",caption:"Cool, measure the exact finished output, then divide into labelled storage packets plus any remainder.",url:hf("20260911_143802_ff9cacd0-23ed-45b3-9c96-3af5e6f05b41")}
 ],
 rempah:[
  ...
  {stage:"04 · MEASURE + PACK",caption:"Cool, measure the exact finished output, then divide into labelled storage packets plus any remainder.",url:hf("20260911_143803_deb881a3-86bb-4eb6-8778-7d999ed534f2")}
 ],
 sambal:[
  ...
  {stage:"04 · MEASURE + PACK",caption:"Cool, measure the exact finished output, then divide into labelled storage packets plus any remainder.",url:hf("20260911_143802_0d7d1c93-d38e-4fd7-adc0-0ab14d985190")}
 ],
 dark:[
  ...
  {stage:"04 · MEASURE + PACK",caption:"Cool, measure the exact finished concentrate, then divide into labelled small storage doses plus any remainder.",url:hf("20260911_143802_70fc7db0-0a51-4815-8448-af85e2a82feb")}
 ],
 blond:[
  ...
  {stage:"04 · MEASURE + PACK",caption:"Cool, measure the exact finished output, then divide into labelled storage packets plus any remainder.",url:hf("20260911_143802_2a034ba1-0d9b-4fc7-9989-172d91e9b4cf")}
 ],
 clear:[
  ...
  {stage:"04 · MEASURE + PACK",caption:"Cool promptly, measure the exact finished output, then divide into practical labelled storage packets plus any remainder.",url:hf("20260914_073645_c9e8b3b8-7144-46d2-984a-554d153f9b23")}
 ],
 onion:[
  ...
  {stage:"04 · MEASURE + PACK",caption:"Cool promptly, measure the exact finished output, then divide into practical labelled storage packets plus any remainder.",url:hf("20260914_073707_5af7f883-5033-466c-a958-3bdec739a226")}
 ]
};