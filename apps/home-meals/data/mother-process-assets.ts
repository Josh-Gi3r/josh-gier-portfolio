...
export const motherProcessImages:Record<string,ProcessAsset[]>={
 red:[
  ...
  {stage:"04 · FREEZE",caption:"90 ml portions frozen first, then moved into labelled bags once solid.",url:hf("20260911_143802_171bc463-255a-4cd0-b26e-f7edb5351b9c")}
 ],
 gold:[
  ...
  {stage:"04 · FREEZE",caption:"60 ml measured pucks make GOLD easy to count into recipes.",url:hf("20260911_143802_ff9cacd0-23ed-45b3-9c96-3af5e6f05b41")}
 ],
 rempah:[
  ...
  {stage:"04 · FREEZE",caption:"60 ml portions keep the broad aromatic mother ready for later mids.",url:hf("20260911_143803_deb881a3-86bb-4eb6-8778-7d999ed534f2")}
 ],
 sambal:[
  ...
  {stage:"04 · FREEZE",caption:"60 ml pucks let sambal prawns, eggs or vegetables start instantly.",url:hf("20260911_143802_0d7d1c93-d38e-4fd7-adc0-0ab14d985190")}
 ],
 dark:[
  ...
  {stage:"04 · FREEZE",caption:"Small 30 ml cubes are enough because DARK is highly concentrated.",url:hf("20260911_143802_70fc7db0-0a51-4815-8448-af85e2a82feb")}
 ],
 blond:[
  ...
  {stage:"04 · FREEZE",caption:"60 ml portions stay flexible for Dijon, mushroom, herb or cream finishes later.",url:hf("20260911_143802_2a034ba1-0d9b-4fc7-9989-172d91e9b4cf")}
 ]
};