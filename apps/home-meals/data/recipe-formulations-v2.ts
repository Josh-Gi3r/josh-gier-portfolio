...
],["saucepan or deep skillet"],[s("Warm GOLD in oil until sizzling."),s("Add chickpeas, cumin, garam masala, amchur and water."),s("Simmer, crushing a few chickpeas to thicken.",true,"Sauce thick enough to coat chickpeas."),s("Finish with coriander and lemon.",false)]),
...
],["saucepan or deep skillet"],[s("Warm oil and sliced green chilli."),s("Add GOLD, spices and water; simmer until glossy.",true,"Sauce glossy and no watery separation."),s("Score or halve the eggs and fold through the sauce for several minutes."),s("Finish with coriander.",false)]),
R("gold-saag-chicken",[
 i("chicken-thigh","Boneless skinless chicken thigh",400,"g"),i("neutral-oil","Ghee or neutral oil",15,"ml"),i("garam-masala","Garam masala",2,"g"),i("water","Water",80,"ml"),i("yoghurt","Plain yoghurt",80,"g","prepared"),i("lemon","Lemon",30,"g","fresh")
],["deep skillet","digital thermometer"],[s("Brown chicken in fat with garam masala."),s("Add GOLD and water and simmer briefly."),s("Add SAAG and continue gently until chicken reaches the safety target.",true,"Green sauce thick and clinging.",CHICKEN),s("Lower heat before stirring in yoghurt; finish with lemon.",true,"Yoghurt stays smooth rather than splitting.")]),
R("gold-aloo-matar",[
...
R("sambal-telur",[
 i("egg-large","Large eggs, hard-boiled",4,"count","prepared"),i("onion-yellow","Onion, sliced",100,"g","fresh"),i("neutral-oil","Neutral oil",5,"ml"),i("cucumber","Cucumber",200,"g","fresh"),i("jasmine-rice-dry","Jasmine rice",120,"g","dry")
],["wok or skillet","rice cooker or saucepan"],[s("Cook the rice separately."),s("Sauté onion until just soft."),s("Add SAMBAL and a small splash of water; heat until glossy."),s("Add eggs and coat for several minutes."),s("Serve with cucumber and rice.",false)]),
R("curry-laksa",[
...
R("brown-chicken-mushroom",[
 i("chicken-thigh","Chicken thigh, sliced",350,"g"),i("mushroom","Mushrooms",250,"g","fresh"),i("spring-onion","Spring onions",45,"g","fresh"),i("neutral-oil","Neutral oil",20,"ml"),i("cornstarch","Cornstarch for slurry",8,"g"),i("water","Water for slurry",15,"ml"),i("jasmine-rice-dry","Jasmine rice",120,"g","dry")
],["wok","rice cooker","digital thermometer"],[s("Sear chicken and remove once at the safety target.",true,"Chicken browned.",CHICKEN),s("Brown mushrooms until released water is gone."),s("Add WOK-B and bring to a simmer; thicken lightly with slurry."),s("Return chicken and finish with spring onion.",true,"Mushrooms browned and sauce glossy, not watery.")]),
R("moo-goo-gai-pan",[
 i("chicken-thigh","Chicken thigh, thinly sliced",300,"g"),i("mushroom","Mushrooms",180,"g","fresh"),i("bok-choy","Bok choy",200,"g","fresh"),i("carrot","Carrot",80,"g","fresh"),i("bamboo-shoots","Bamboo shoots",80,"g","prepared"),i("neutral-oil","Neutral oil",20,"ml"),i("cornstarch","Cornstarch for slurry",8,"g"),i("water","Water for slurry",15,"ml")
],["wok","digital thermometer"],[s("Velvet or lightly marinate chicken, sear and remove at the safety target.",true,"Chicken tender, not browned hard.",CHICKEN),s("Stir-fry mushrooms and vegetables until crisp-tender."),s("Add WOK-W and simmer briefly; thicken lightly with slurry."),s("Return chicken and toss only until coated.",true,"Pale glossy sauce and crisp vegetables.")]),
...
],["oven/broiler or air fryer","sheet pan","digital thermometer"],[s("Coat salmon with MISO-G and marinate chilled if time allows."),s("Wipe off heavy excess surface marinade to reduce burning."),s("Broil/bake until caramelised and salmon reaches the safety target.",true,"Caramelised surface, not blackened miso.",FISH),s("Cook mushrooms and broccoli alongside or separately; serve with rice.")]),
R("miso-aubergine-tofu",[
 i("aubergine","Aubergine",500,"g"),i("tofu","Firm tofu",300,"g","prepared"),i("sesame-oil","Sesame oil",15,"ml"),i("spring-onion","Spring onion",30,"g","fresh"),i("sesame-seed","Sesame seeds",5,"g"),i("jasmine-rice-dry","Rice",100,"g","dry")
],["oven or air fryer","frying pan optional"],[s("Score aubergine and roast until nearly tender."),s("Crisp tofu in a pan or air fryer."),s("Brush aubergine and tofu with MISO-G and return to high heat until glazed.",true,"Aubergine soft inside, glaze caramelised but not burnt."),s("Finish with spring onion and sesame; serve with rice.")]),
R("bulgogi-beef",[
 i("beef-sirloin","Thinly sliced sirloin/hotpot beef",350,"g"),i("spring-onion","Spring onion",30,"g","fresh"),i("sesame-seed","Sesame seeds",5,"g"),i("jasmine-rice-dry","Rice",120,"g","dry")
],["very hot skillet or grill","rice cooker","digital thermometer"],[s("Marinate beef in BUL while refrigerated."),s("Heat skillet/grill very hot and cook beef in a thin layer so it sears rather than steams."),s("Cook to the whole-cut safety target, then finish with spring onion and sesame.",true,"Edges browned and caramelised, no wet steaming pool.",WHOLE_BEEF),s("Serve with rice; lettuce-wrap variant is modeled separately.")]),
R("gochujang-chicken",[
...
R("chicken-cacciatore",[
 i("chicken-thigh","Boneless skinless chicken thighs",450,"g"),i("olive-oil","Olive oil",10,"ml"),i("red-pepper","Red bell pepper",150,"g","fresh"),i("mushroom","Mushrooms",180,"g","fresh"),i("red-wine","Dry red wine",60,"ml","prepared"),i("rosemary","Rosemary",2,"g","fresh"),i("parsley","Parsley",10,"g","fresh"),i("black-pepper","Black pepper",1,"g"),i("potato","Baby potatoes",300,"g")
],["wide covered pan","pot for potatoes","digital thermometer"],[s("Cook potatoes concurrently."),s("Brown chicken deeply and remove."),s("Brown mushrooms until moisture has largely evaporated; soften pepper."),s("Deglaze with wine, reduce, then add RED, DARK and rosemary."),s("Return chicken, braise gently to the safety target, then uncover to reduce.",true,"Sauce coats; chicken browned and tender.",CHICKEN),s("Finish with parsley and black pepper.")]),
R("mustard-mushroom-chicken",[
 i("chicken-thigh","Boneless skinless chicken thighs",400,"g"),i("neutral-oil","Neutral oil",10,"ml"),i("mushroom","Fresh mushrooms",150,"g","fresh"),i("dijon","Dijon mustard",20,"g","prepared"),i("cream","Cooking cream, ~20% fat",80,"ml","prepared"),i("water","Water",80,"ml"),i("parsley","Parsley",10,"g","fresh"),i("black-pepper","Black pepper",1,"g"),i("potato","Baby potatoes",300,"g"),i("green-beans","Green beans",200,"g","fresh")
],["wide skillet","pot/steamer for sides","digital thermometer"],[s("Cook potatoes and green beans alongside the main."),s("Sear chicken deeply and remove."),s("Brown mushrooms until their water is gone."),s("Add BLOND, DUX and DARK; fry briefly, then add Dijon and water."),s("Lower heat before cream; return chicken and cook to the safety target.",true,"Sauce smooth and coating; mushrooms browned rather than pale.",CHICKEN),s("Finish with parsley and black pepper.")]),
R("pesto-salmon",[
 i("salmon","Salmon fillets",340,"g"),i("broccoli","Broccoli",250,"g","fresh"),i("zucchini","Zucchini",250,"g","fresh"),i("lemon","Lemon",30,"g","fresh"),i("parmesan","Parmesan",10,"g","prepared",true)
],["oven or air fryer","sheet pan","digital thermometer"],[s("Roast/air-fry vegetables until browned at the edges."),s("Cook salmon to the safety target.",true,"Salmon moist and just flaking; verify with thermometer.",FISH),s("Loosen PESTO with lemon and a small spoon of warm water if needed."),s("Spoon PESTO over fish and vegetables; finish with optional Parmesan.",false)]),
R("red-shakshuka",[
