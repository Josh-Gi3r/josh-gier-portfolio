...
const CHICKEN=75,FISH=63,WHOLE_BEEF=63,GROUND_MEAT=75;
...
R("gold-punjabi-egg-curry",[
 i("egg-large","Large eggs, hard-boiled",4,"count","prepared"),i("neutral-oil","Neutral oil",15,"ml"),i("green-chilli","Green chilli",1,"count","fresh"),i("garam-masala","Garam masala",2,"g"),i("paprika","Paprika",2,"g"),i("water","Water",120,"ml"),i("coriander","Fresh coriander",10,"g","fresh"),i("basmati-rice-dry","Basmati rice",100,"g","dry")
],["saucepan or deep skillet","rice cooker or saucepan"],[s("Cook the rice separately."),s("Optional but better textured: lightly score and blister the peeled eggs in a little of the measured oil; remove."),s("Warm remaining oil and sliced green chilli."),s("Add GOLD, spices and water; simmer until glossy.",true,"Sauce glossy and no watery separation."),s("Return the eggs and coat for several minutes."),s("Finish with coriander.",false)]),
R("gold-saag-chicken",[
...
R("thai-red-chicken",[
 i("chicken-thigh","Boneless skinless chicken thigh",400,"g"),i("coconut-milk","Full-fat coconut milk",400,"ml","prepared"),i("pumpkin","Kabocha or pumpkin",300,"g"),i("fish-sauce","Fish sauce",22.5,"ml","prepared"),i("palm-sugar","Palm sugar",5,"g"),i("thai-basil","Thai basil",15,"g","fresh"),i("makrut-lime","Makrut lime leaves",3,"count","fresh"),i("jasmine-rice-dry","Jasmine rice",100,"g","dry")
],["saucepan","rice cooker or saucepan","digital thermometer"],[s("Cook the rice separately."),s("Fry THAI-R in concentrated coconut cream until aromatic."),s("Add chicken and coat in paste."),s("Add remaining coconut milk, pumpkin and makrut leaves; simmer until pumpkin is tender and chicken is safe.",true,"Pumpkin tender but not collapsed; sauce aromatic with light oil separation.",CHICKEN),s("Balance with fish sauce and palm sugar; finish with basil.")]),
R("massaman-beef",[
 i("beef-chuck","Beef chuck, 3 cm cubes",500,"g"),i("coconut-milk","Coconut milk",400,"ml","prepared"),i("water","Water",400,"ml"),i("potato","Potatoes",300,"g"),i("onion-yellow","Onion",150,"g"),i("peanuts","Roasted peanuts",35,"g"),i("tamarind","Tamarind",15,"ml","prepared"),i("fish-sauce","Fish sauce",22.5,"ml","prepared"),i("palm-sugar","Palm sugar",12,"g")
],["Dutch oven or heavy saucepan","digital thermometer"],[s("Brown beef well."),s("Fry THAI-R and MASS briefly, then add coconut milk and beef."),s("Add water and braise gently, covered, until the beef is genuinely fork-tender, usually 90–120 minutes for chuck; only then add potato and onion.",true,"Beef yields easily to a fork before potato goes in."),s("Finish with tamarind, fish sauce, palm sugar and peanuts; reduce until rich.",true,"Beef tender and sauce rich; safety minimum is not the same as tenderness.",WHOLE_BEEF)]),
R("pad-kra-pao",[
 i("ground-chicken","Ground chicken thigh",350,"g"),i("fish-sauce","Fish sauce for seasoning the raw chicken",5,"ml","prepared"),i("onion-yellow","Onion, thinly sliced",50,"g","fresh"),i("water","Water",30,"ml"),i("holy-basil","Holy basil leaves",35,"g","fresh"),i("egg-large","Large eggs",2,"count"),i("neutral-oil","Neutral oil",20,"ml"),i("jasmine-rice-dry","Jasmine rice",120,"g","dry")
],["wok","small frying pan for eggs","rice cooker or saucepan","digital thermometer"],[s("Start rice and fry eggs separately to the preferred doneness."),s("Heat wok very hot; fry G and CH briefly, then add onion and stir-fry until just translucent."),s("Season the ground chicken with the measured fish sauce, add it to the wok and cook quickly without drying it out."),s("Add KRAPOW with the measured water and toss until glossy; cook chicken to the safety target.",true,"No watery pool; seasoning coats the meat.",CHICKEN),s("Turn off heat and fold in holy basil only until wilted.",true,"Basil vivid and just collapsed.")]),
R("pad-see-ew",[
