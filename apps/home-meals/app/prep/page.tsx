...
export default function PrepPage(){
 return <div className="page foundation-page">
  ...
  <YieldGraphic/>
  <section className="system-photo-pair"><figure><img src={foundationImages.prepDay} alt="Home Meals prep-day workstation"/><figcaption><span>PREP DAY</span><strong>Parallel work, not twelve separate recipes.</strong></figcaption></figure><figure><img src={foundationImages.freezer} alt="Organised Home Meals freezer"/><figcaption><span>FREEZER STATE</span><strong>Bases, protein, vegetables and carbs each get a home.</strong></figcaption></figure></section>
  ...
  <PortionLanguage/>
  <section className="system-photo-single"><img src={foundationImages.cubes} alt="Measured Home Meals freezer cube system"/><div><span className="eyebrow">MEASURED, THEN LABELLED</span><h2>15 / 30 / 60 / 90 ml becomes the physical language of the kitchen.</h2></div></section>
  <PrepTimelineGraphic/>
  <StorageGraphic/>
