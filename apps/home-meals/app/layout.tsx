...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body><PwaRuntime/><HouseholdStateProvider><SmartAskRuntime/><VisionRuntime/><Shell>{children}</Shell><HomeDock/><HouseholdSync/><VoiceRuntime/></HouseholdStateProvider></body></html>}
