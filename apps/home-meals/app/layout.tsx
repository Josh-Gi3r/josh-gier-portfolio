...
import {HomeGuideProvider} from "@/components/HomeGuide";
import {JoshPresenceProvider} from "@/components/JoshPresence";
...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en" className={jakarta.variable}><body><PwaRuntime/><HouseholdStateProvider><JoshPresenceProvider><HomeGuideProvider><SmartAskVisibility/><SmartAskRuntime/><VisionRuntime/><Shell>{children}</Shell><HomeBar/><HouseholdSyncV12/><VoiceRuntime/><FirstRunKitchen/></HomeGuideProvider></JoshPresenceProvider></HouseholdStateProvider></body></html>}
