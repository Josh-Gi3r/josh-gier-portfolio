...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body><PwaRuntime/><HouseholdStateProvider><Shell>{children}</Shell></HouseholdStateProvider></body></html>}
