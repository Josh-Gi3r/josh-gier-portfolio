...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en" className={jakarta.variable}><body><PwaRuntime/><HouseholdStateProvider><HomeGuideProvider><SmartAskVisibility/><SmartAskRuntime/><VisionRuntime/><Shell>{children}</Shell><HomeBar/><HouseholdSyncV12/><VoiceRuntime/><FirstRunKitchen/></HomeGuideProvider></HouseholdStateProvider></body></html>}
