...
export function BaseExplorer(){
 ...
 return <section className="hm-base-explorer-v5">
  <header><div><span>MOTHER → MID → DINNER</span><h2>See the connections</h2></div><small>{mother.approxMeals} dish ideas · {dinnerIds.length} saved</small></header>
