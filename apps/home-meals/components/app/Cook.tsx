...
export function Cook(){
 const h=useHousehold();const[q,setQ]=useState("");const[cuisine,setCuisine]=useState("All");
 ...
 return <div className="hm-page-v5 hm-cook-v5">
  ...
  <div className="hm-search-row-v5"><label className="hm-search-v5"><span>⌕</span><input value={q} onChange={e=>setQ(e.target.value)} placeholder="Search recipes"/></label><Link href="/cook/builder">From what we have</Link></div>
  {!q&&cuisine==="All"&&<>
