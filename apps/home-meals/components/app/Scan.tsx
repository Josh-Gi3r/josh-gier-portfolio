...
export function Scan(){const[mode,setMode]=useState<Mode>("Fridge");const[preview,setPreview]=useState<string>();const[error,setError]=useState("");const[back,setBack]=useState("/");const[fileNonce,setFileNonce]=useState(0);
 ...
 const clearPreview=()=>{if(preview)URL.revokeObjectURL(preview);setPreview(undefined);setError("");setFileNonce(n=>n+1)};
