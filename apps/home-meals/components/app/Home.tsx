...
export function Home(){
 ...
 return <div className="hm-page-v5 hm-home-v5">
  ...
  <section className="hm-tonight-v5">{tonight.image?<img src={tonight.image} alt="" width={780} height={520} loading="eager" fetchPriority="high" decoding="async"/>:<div/>}<div className="hm-tonight-shade-v5"/><div className="hm-tonight-content-v5"><div className="hm-tonight-meta-v5"><RecipeReady recipe={tonight}/><span>{tonight.minutes} min</span></div><h2>{recipeTitle(tonight.id,tonight.title)}</h2><p>{recipeSubtitle(tonight.id,tonight.subtitle)}</p><div className="hm-tonight-actions-v5"><Link href={heroHref}>{heroLabel}</Link><Link href="/plan">Swap</Link></div></div></section>
