...
export function Mids(){
 const h=useHousehold();const[q,setQ]=useState("");const[scope,setScope]=useState<Scope>("week");
 ...
 return <div className="hm-page-v5 hm-mids-v5"><Back href="/prep" label="Prep"/><PageHead eyebrow="MIDS" title="Mid-bases" sub="Small batches that turn the same foundations into different dinners."/>
