...
export function Mids(){
 ...
 return <div className="hm-page-v5 hm-mids-v5"><Back href="/prep" label="Prep"/><PageHead eyebrow="MIDS" title="Mid-bases" sub="Small batches that give our foundations more range."/>
