...
const cards=[
 ...
 {href:"/learn/portions",icon:"▦",title:"Freezer portions",copy:"Why DARK is tiny, GOLD is modular and stock freezes bigger."},
...
export function Guide({slug}:{slug:string}){const data:Record<string,{title:string;sub:string;steps:string[]}>={
 system:{title:"How Home Meals fits together",sub:"The app follows the same dinner from planning to the next version.",steps:["Pick the week’s recipes.","Check what is already in the kitchen.","Buy only what is missing.","Prep only what the week is short of.","Cook from the same recipe quantities.","Rate it and leave a note for next time."]},
 portions:{title:"Freezer portions",sub:"Strong things stay small. Bulky bases and stock freeze bigger.",steps:["30 ml: strong sauce or concentrate.","60 ml: small sauce/base module.","120–250 ml: larger dinner components.","350–500 ml: tomato sauce or stock.","Label name, amount and date."]},
