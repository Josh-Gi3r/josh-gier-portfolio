...
export function Kitchen(){
 ...
 const relevantIds=useMemo(()=>new Set(h.week.flatMap(id=>ingredientsForRecipeV7(id).map(canonicalIngredientIdForRuntimeV7))),[h.week]);
