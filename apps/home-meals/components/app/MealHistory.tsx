...
import {mealHistorySummaryV2} from "@/data/meal-history-v2";
import {recipeTitle} from "@/data/recipe-display";
import {RoundBack,SectionHead,Stat} from "./Primitives";

export function MealHistory(){
 const h=useHousehold();const summary=useMemo(()=>mealHistorySummaryV2({history:h.history,favourites:h.favourites,ratings:h.ratings}),[h.history,h.favourites,h.ratings]);
