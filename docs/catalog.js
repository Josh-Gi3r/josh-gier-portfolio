...
const changes={
 lego:{color:'#0052c9',image:'lego-sculpture',hero:'lego-sculpture',gallery:['lego-detail','lego-film','lego-gift','lego-hero','lego-interior','lego-journey','lego-oob','lego-social','lego-board'],logo:'lego-logo',art:'lego',
  ...
  credit:'KDArena led creators, video distribution, localisation and the ecommerce journey as activation partner to the lead agency.'},
 revolut:{color:'#2256f2',image:'revolut-metal',hero:'revolut-metal',gallery:['revolut-creator','revolut-funnel','revolut-hero','revolut-journey','revolut-metro','revolut-payment','revolut-social','revolut-tiktok','revolut-board'],logo:'revolut-logo',art:'revolut',
  ...
  credit:'KDArena led the French-market acquisition scope from creative through funded account as activation partner to the lead agency.'},
 bosch:{logo:'bosch-logo',color:'#e32636',
  ...
  credit:'KDArena led the participation platform, creator mechanics, paid distribution and CRM for the programme.'},
 tiger:{logo:'tiger-logo',
  ...
  credit:'KDArena led campaign technology, social distribution and measurement for the lead agency’s integrated campaign.'},
 pif:{image:'pif-cover',hero:'pif-cover',gallery:['pif-arena','pif-briefing','pif-linkedin','pif-newsroom','pif-studio','pif-board'],
  ...
  credit:'KDArena led narrative adaptation, paid and social distribution, newsroom operations and stakeholder follow-up for the institutional communications team.'},
 veve:{logo:'veve-logo',
  ...
  credit:'KDArena led GTM and social strategy, drop campaigns, creators, paid app acquisition and collector lifecycle for the platform’s licensed-IP releases.'},
 ygg:{image:'ygg-cover',hero:'ygg-cover',gallery:['ygg-creator','ygg-guild','ygg-markets','ygg-onboarding','ygg-tournament','ygg-board'],
  ...
  credit:'KDArena was the embedded growth team, leading country positioning, local-language community operations, creators and the fundraise narrative.'},
 saitama:{image:'saitama-cover',hero:'saitama-cover',gallery:['saitama-clippers','saitama-holders','saitama-kol','saitama-spaces','saitama-board'],
  ...
  credit:'Josh led positioning, the KOL programme, the clipping network, Telegram and Spaces operations and PR for the project.'},
 bubblemaps:{image:'bubblemaps-cover',hero:'bubblemaps-cover',gallery:['bubblemaps-analyst','bubblemaps-investigation','bubblemaps-launch','bubblemaps-mobile','bubblemaps-board'],
  ...
  credit:'KDArena led category education, the pre-launch community, the KOL programme and launch communications for the BMT token generation event.'},
 jedstar:{image:'jedstar-cover',hero:'jedstar-cover',gallery:['jedstar-investor','jedstar-platform','jedstar-presale','jedstar-tokenomics','jedstar-board'],
  ...
  credit:'KDArena was engaged from inception and led the brand, product proposition, community, presale and investor go-to-market.'},
 ...
 cbre:{logo:'cbre-logo',image:'cbre-cover',hero:'cbre-cover',caseHero:false,gallery:[],
  metrics:[['18','Enterprise products'],['7','APAC markets'],['~US$100M','Annual revenue across broader service lines'],['~US$1B','Broader NTT GWS mandate']]},
 ...
 aier:{image:'aier-cover',hero:'aier-cover',caseHero:false,gallery:[],
  metrics:[['US$1.2M','ARR within first year'],['US$3M','Acquisition'],['~US$12M','Post-acquisition revenue'],['30+','Markets']]},
 ...
 cult:{image:'cult-cover',hero:'cult-cover',gallery:['cult-manifesto','cult-seeding','cult-spread','cult-board'],
  ...
  credit:'Josh led positioning, manifesto material, micro-KOL seeding and crypto media for the launch.'},
 immortal:{image:'immortal-cover',hero:'immortal-cover',gallery:['immortal-grandmaster','immortal-stream','immortal-token2049','immortal-tournament','immortal-board'],
  ...
  credit:'KDArena was the client’s growth partner, leading positioning, grandmaster and creator partnerships, tournament campaigns and community operations.'}
};
