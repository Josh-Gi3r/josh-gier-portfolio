...
const changes={
 ...
 cult:{image:'cult-cover',hero:'cult-cover',metrics:[['US$150M','Reported market cap · under 2 months']],metricNote:'Historical ecosystem valuation supplied in the portfolio; not agency revenue or a solely attributed result.'},
 immortal:{image:'immortal-cover',hero:'immortal-cover',metrics:[['~50K','Registered players'],['US$15.5M','Company funding']],metricNote:'Company-scale outcomes recorded in the supplied portfolio; funding is not revenue attributed to a campaign.'}
};
